      ...
      <main className="flex-1">
        ...
        <div className="flex flex-col sm:grid sm:grid-cols-2 gap-8 p-4 sm:p-8">
          ...
          <div className="text-slate-400 text-lg">
            <p className="mb-6">
              I'm a Devops Engineer with a passion for smoothing developer velocity and enhancing system reliability. 
              With a strong foundation in software engineering, I specialize in building and deploying
